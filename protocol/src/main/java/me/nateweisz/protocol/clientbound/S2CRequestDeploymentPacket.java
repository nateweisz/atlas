...
public class S2CRequestDeploymentPacket implements Packet {
    private final UUID deploymentId; // used for the callback when it is deployed and all other
                                     // future sent packets.
    ...
    private final String commitHash; // TODO: in the future this should likely be a metadata tag
                                     // when we support non git stuff.
